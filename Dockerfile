...
MAINTAINER igorcferreira <igorcferreira@hotmail.com>
...
# Install android ndk
RUN wget http://dl.google.com/android/ndk/android-ndk-r10e-linux-x86_64.tar.bz2
RUN tar -xvjf android-ndk-r10e-linux-x86_64.tar.bz2
...
RUN cd /; rm android-sdk_r24.3.3-linux.tgz && rm android-ndk-r10e-linux-x86_64.tar.bz2 && rm apache-ant-1.8.4-bin.tar.gz

# Install latest android (22.0.1 / 5.0.1) tools and system image.
RUN echo "y" | android update sdk --no-ui --force --filter platform-tools,android-22,build-tools-22.0.1,sysimg-22
